...
const counselersData = [
  {
    ...
    counseleeMeetingsCountMin: 6,
    counseleeMeetingsCountMax: 10,
    counseleeMeetingsCountAvg: 8,
    lastSixMonthMorningProgramAttendedCount: 70,
    lastTwoMonthMorningProgramAttendedCount: 30,
  },
  {
    firstName: "Bob",
    lastName: "Johnson",
      ...
      >
        <table>
          <thead>
            ...
            >
              <th className="text-xs text-gray-500 py-3 px-4">FIRST NAME</th>
              <th className="text-xs text-gray-500 py-3 px-4">LAST NAME</th>
              ...
              <th className="text-xs text-gray-500 py-3 px-4">EMAIL</th>
              <th className="text-xs text-gray-500 py-3 px-4">ADDRESS</th>
              ...
              <th className="text-xs text-gray-500 py-3 px-4">
                COUNSELEE MEETING MIN
              </th>
              <th className="text-xs text-gray-500 py-3 px-4">
                COUNSELEE MEETING MAX
              </th>
              <th className="text-xs text-gray-500 py-3 px-4">
                COUNSELEE MEETING avg
              </th>
              <th className="text-xs text-gray-500 py-3 px-4">
                MORNING PROGRAM ATTEND COUNT (6 M)
              </th>
              <th className="text-xs text-gray-500 py-3 px-4">
                MORNING PROGRAM ATTEND COUNT (2 M)
              </th>
              <th className="text-xs text-gray-500 py-3 px-4">
                MAX COUNSELEE MEETING COUNT ATTENDANCE(ONLINE)
              </th>
              <th className="text-xs text-gray-500 py-3 px-4">
                MAX COUNSELEE MEETING COUNT ATTENDANCE(OFFLINE)
              </th>
              <th className="text-xs text-gray-500 py-3 px-4">
                MIN COUNSELEE MEETING COUNT ATTENDANCE(ONLINE)
              </th>
              <th className="text-xs text-gray-500 py-3 px-4">
                MIN COUNSELEE MEETING COUNT ATTENDANCE(OFFLINE)
              </th>

              <th className="text-xs text-gray-500 py-3 px-4">
                AVG COUNSELEE MEETING COUNT ATTENDANCE(ONLINE)
              </th>
              <th className="text-xs text-gray-500 py-3 px-4">
                AVG COUNSELEE MEETING COUNT ATTENDANCE(OFFLINE)
              </th>
              <th className="text-xs text-gray-500 py-3 px-4">
                LAST COUNSELEE MEETING DATE
              </th>
            </tr>
          </thead>
          <tbody>
            {counselersData?.map((counselor, index) => (
              ...
              >
                ...
                <td className=" whitespace-nowrap text-center py-5 px-4">
                  {counselor.counseleeMeetingsCountMin}
                </td>
                <td className=" whitespace-nowrap text-center py-5 px-4">
                  {counselor.counseleeMeetingsCountMax}
                </td>
                <td className=" whitespace-nowrap text-center py-5 px-4">
                  {counselor.counseleeMeetingsCountAvg}
                </td>
                <td className=" whitespace-nowrap text-center py-5 px-4">
                  {counselor.lastSixMonthMorningProgramAttendedCount}
                </td>
                <td className=" whitespace-nowrap text-center py-5 px-4">
                  {counselor.lastTwoMonthMorningProgramAttendedCount}
                </td>
                <td className=" whitespace-nowrap text-center py-5 px-4 bg-yellow-400">
                  {counselor.lastSixMonthMorningProgramAttendedCount}
                </td>
                <td className=" whitespace-nowrap text-center py-5 px-4 bg-green-400">
                  {counselor.lastTwoMonthMorningProgramAttendedCount}
                </td>
                <td className=" whitespace-nowrap text-center py-5 px-4 bg-yellow-400">
                  {counselor.lastSixMonthMorningProgramAttendedCount}
                ...
                <td className=" whitespace-nowrap text-center py-5 px-4">
                  <DateDisplay dateString={new Date().toString()} />
                </td>
              </tr>
            ))}
          </tbody>
