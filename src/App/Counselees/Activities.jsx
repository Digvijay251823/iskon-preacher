...
function ActivitiesCounselee() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen overflow-x-hidden">
      <h1 className="font-semibold text-red-500 text-xl mb-10">
        ActivitiesCounselee
      </h1>
      {counselerError && (
          ...
          >
            <div className="mb-5">
              ...
              <p className="text-gray-400">
                select a session below that you want to mark your
                ActivitiesCounselee of
              </p>
            </div>
...
export default ActivitiesCounselee;
